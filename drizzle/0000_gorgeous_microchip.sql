...
ALTER TABLE "user_feedback" ADD CONSTRAINT "user_feedback_user_id_auth_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."auth_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_ai_token_usage_provider_created" ON "ai_token_usage" USING btree ("provider","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_conversations_transcription_started" ON "conversations" USING btree ("transcription_started_at");--> statement-breakpoint
